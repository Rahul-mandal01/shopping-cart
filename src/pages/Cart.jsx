        ...
        
        {
            ...
            (
                <div className="min-h-[80vh] flex flex-col items-center justify-center" >
                    ...
                    <NavLink to="/">
                        <button className=" bg-green-600 hover:bg-purple-50 rounded-lg text-white uppercase tracking-wider 
                        font-semibold hover:text-green-700 transition duration-300 ease-linear mt-5 border-2 border-green-600 p-3 px-10 " >
                            Shop Now
                        </button>
                    </NavLink>
                </div>
